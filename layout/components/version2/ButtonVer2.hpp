...
struct ButtonVer2 : Box {

    ButtonVer2(sf::Vector2f const& position, sf::Vector2f const& size, std::string const& btnText);

    ~ButtonVer2() override = default;
    ...
    auto getButtonText() const -> const TextWrapperVer2&;
